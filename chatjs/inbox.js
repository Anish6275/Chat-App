var username;
//var Ses_img = "https://baatcheet.cf/ProfilePic/uu11.jpg";
...
// function setUser(malik){
//     ui = malik;
//     username = document.getElementById("#ui");
// }

//var chating;
function chatWith(chatuser,c,u,toid,img,status) {
    //chating = chatuser;
    ci = c;
    ui = u;
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle,toid,img,send) {
    ...
    if((event.keyCode == 13 && event.shiftKey == 0) || (send == 1))  {
        ...
        if (message != '') {
            ...
            // sendToDataBase(msg,"sadas",chatuser);
            // console.log("...");
            ///////////////
            scrollDown();
        }
...
function sendToDataBase(mss, org, dest){
    //console.log(mss + org + dest);
    scrollDown();
    $.post("sendToServer.php", {text: mss, org: org, dest: dest});
